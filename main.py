...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--mode', type=str, choices=['picture', 'novel'], help='采集模式：picture(图片)或novel(小说)')
    ...
    for forum in forums:
        ...
        while current_page <= config['crawl']['max_pages']:
            ...
            for topic in topics:
                ...
                # 解析帖子内容
                topic_content = parser.parse_topic_page(topic_html, crawl_mode, site_domain=site_domain)
